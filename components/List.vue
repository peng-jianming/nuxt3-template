...
<template>
  <div class="-mb-120 desktop:pt-90 desktop:px-78 desktop:-mb-60 relative">
    ...
    <mobile-search v-model="options.title" class="px-30 pt-150 pb-40" placeholder="搜索动态" @search="loadData(true)" />
    ...
    <div class="min-h-500">
      <client-only>
        ...
        <img v-else class="w-250 mx-auto mt-150" src="/img/empty.gif" alt="">
      </client-only>
    </div>
  </div>
</template>
