...
<template>
  <div class="-mb-100 desktop:-mb-50">
    <div v-for="(item, key) in pageConfig" :key="key" class="flex flex-col items-center mt-70 desktop:mt-60">
      ...
      <div
        class="text-22 desktop:text-10 text-[#666] text-center mt-30 desktop:mt-15 leading-39 desktop:leading-18"
        v-html="item.desc"
      />
      <!-- 移动端 -->
      <div class="desktop:hidden">
        ...
        <div
          class="px-60 pt-15  text-31 leading-50 mt-15  text-primary text-center"
      ...
      <div class="hidden desktop:block relative mt-10">
        <parenting-loop-pic :list="data[key]" @open-dialog="handleOpenDialog(item.videoDialogBg, $event)" />
