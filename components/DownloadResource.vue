...
<template>
  <div
    class="w-198 h-58 flex text-28 leading-58 pl-25 mx-auto desktop:mx-0 mb-20 group desktop:order-3 order-4 desktop:my-20 desktop:w-69 desktop:h-20 desktop:text-9 desktop:pl-10 desktop:leading-20 text-primary bg-download-bg bg-no-repeat bg-cover cursor-pointer hover:bg-download-bg-active hover:text-bgc"
